...
const regulatorySettingsSchema = z.object({
  ...
  unforeseenMaxExtensionHours: z.coerce.number().nonnegative(),
  unforeseenMaxDutyHours: z.coerce.number().positive(),
  currencyDayTakeoffsRequired: z.coerce.number().int().positive(),
  currencyDayLandingsRequired: z.coerce.number().int().positive(),
  currencyNightTakeoffsRequired: z.coerce.number().int().positive(),
  currencyNightLandingsRequired: z.coerce.number().int().positive(),
  currencyPeriodMonths: z.coerce.number().int().positive(),
  instrumentApproachesRequired: z.coerce.number().int().positive(),
  instrumentApproachesPeriodMonths: z.coerce.number().int().positive(),
