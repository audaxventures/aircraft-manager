        ...
        <TabsContent value="regulatory">
          <RegulatorySettingsForm
            settings={{
              ...
              unforeseenMaxExtensionHours: toNumber(regSettings.unforeseenMaxExtensionHours),
              unforeseenMaxDutyHours: toNumber(regSettings.unforeseenMaxDutyHours),
              currencyDayTakeoffsRequired: regSettings.currencyDayTakeoffsRequired,
              currencyDayLandingsRequired: regSettings.currencyDayLandingsRequired,
              currencyNightTakeoffsRequired: regSettings.currencyNightTakeoffsRequired,
              currencyNightLandingsRequired: regSettings.currencyNightLandingsRequired,
              currencyPeriodMonths: regSettings.currencyPeriodMonths,
              instrumentApproachesRequired: regSettings.instrumentApproachesRequired,
              instrumentApproachesPeriodMonths: regSettings.instrumentApproachesPeriodMonths,
