...
import { DutyLogActions } from "@/components/duty/duty-log-actions";
...
export default async function DutyDaysPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Duty Days"
        description="CARS 604 flight duty time compliance."
        icon={Timer}
        action={<DutyLogActions logs={logs} pilots={pilots} />}
      />
