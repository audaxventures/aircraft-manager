...
import { UnforeseenCircumstancesReport } from "@/lib/pdf/unforeseen-circumstances-report";
...
export async function GET(request: NextRequest) {
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="unforeseen-circumstances-report-${new Date().toISOString().slice(0, 10)}.pdf"`,
    },
  });
}
